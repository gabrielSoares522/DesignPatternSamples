...
{
    public class DetranBAVerificadorDebitosRepository : DetranVerificadorDebitosRepositoryCrawlerBase
    {
        private readonly ILogger _Logger;

        public DetranBAVerificadorDebitosRepository(ILogger<DetranPEVerificadorDebitosRepository> logger)
        {
            _Logger = logger;
        }
        ...
        protected override Task<string> RealizarAcesso(Veiculo veiculo)
        {
            ...
            _Logger.LogDebug($"Consultando débitos do veículo placa {veiculo.Placa} para o estado de BA.");
